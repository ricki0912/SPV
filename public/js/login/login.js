function verifyForm(e) {
    ...
    return $(":input", e).each(function() {
        ...
        if (
            ...
            "radio" != e && 
            "number" != e || 
            (t.val() ? (t.removeClass("is-invalid"), a = !0) : (t.addClass("is-invalid"), a = !1)
...
$(document).ready(function() {
    ...
    a.find("input[name=user]").val(e.email), a.find("select[name=role]").val(e.role), $("#login").submit(function(r) {
        ...
        //alert(l.val()+"   "+o.val()+"  "+a.find("input[name=password]").val());
        e.email = l.val(), e.role = o.val(), verifyForm(a) ? $.ajax({
            url: "http://localhost:8080/SPV/public/validate/login/user/",
            method: "POST",
            data: a.serialize(),
